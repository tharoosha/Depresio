                  ...
                  <div className="AI__wrapper__inner AI__wrapper__inner__2">
                     ...
                     <div className="AI__wrapper__inner__2__body mt--24">
                        <div className="AI__wrapper__inner__2__body__chat chat--wrapper">
                           ...
                           <p>I'm feeling overwhelmed and stressed out with my workload. It's becoming difficult to keep up. What should I do for this?</p>
                        </div>
                        <div className="AI__wrapper__inner__2__body__chat chat--wrapper">
                           <div className="flex">
                              <div className="disp--block">
                           ...
                           <p className="chat--para">I understand that feeling overwhelmed and stressed with your workload can be challenging.</p>
